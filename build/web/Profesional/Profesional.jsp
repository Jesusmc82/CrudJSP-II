...
<div class="bg1">
        ...
        <p style="font-size:200%; margin-left:30px;">Profesional:</p>
        <a href=../menu.jsp><button class="button2" width="80%">Pagina Principal</button></a>
        <a href=AgregaProfesional.jsp><button class="button2" width="80%">Nueva Profesional</button></a>
